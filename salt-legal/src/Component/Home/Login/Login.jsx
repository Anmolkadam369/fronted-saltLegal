...
import { jwtTokenState, userIdState, paidUserState } from "../../auth/atoms";
...
function Login() {
  ...
  const [paidUser, setPaidUser] = useRecoilState(paidUserState);
    ...
    try {
      ...
      if (response.ok) {
        ...
        const userId = responseData.data.userId;
          const isPaidUser = responseData.data.isPaidUser;
          ...
          sessionStorage.setItem('isPaidUser', isPaidUser);
